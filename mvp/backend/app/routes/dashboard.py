...
async def get_dashboard_stats(
    ...
    # Create a mapping of key_id to key_name
    key_name_map = {k.id: k.key_name for k in all_keys}
    ...
    for i in range(num_days):
        ...
        for key in filtered_keys:
            ...
            interaction_point[key.key_name] = len(key_interactions)
            expense_point[key.key_name] = round(sum(inter.estimated_cost or 0 for inter in key_interactions), 2)
    ...
    available_keys = [{'id': k.id, 'name': k.key_name} for k in all_keys]
